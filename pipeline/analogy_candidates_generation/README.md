This folder is related to Section 3.1 -- Analogy Candidates Generation in the paper. <br>
...
* The code for generation (employing these prompts) in the following file: "generate_analogy_candidates.py" 
